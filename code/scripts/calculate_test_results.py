...
TEST_RESULTS_TARGET_PATH = yaml_params["TEST_RESULTS_TARGET_PATH"]
...
def main(data_paths:str, test_results_target_path: str, intervention_column:str, target_column:str,tests_to_run:str):
    for data_path in data_paths:
        ...
        pd.to_pickle(new_all_pca_vals_radiuses,f"{test_results_target_path}/{pkl_name}.pkl")
...
if __name__=="__main__":
    ...
    main(
        ...
        test_results_target_path = TEST_RESULTS_TARGET_PATH, 
