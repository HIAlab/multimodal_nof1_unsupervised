...
from src.AE_utils import FINAL_IMAGE_SIZE, default_trans, non_trans
import sys
import builtins
import os
...
def main(dir_path:str, output_dir_path:str, all_IDs: list, 
    ...
    paths = fast_scandir(dir_path, specific_dirs=specific_dirs)
    ...
    for i, data_path in enumerate(paths):
        ...
        for split_n, ids_to_keep in enumerate(all_ids):
            ...
            analysis = EmbeddingsAE(data_path, output_paths[i], split_number, ids_to_keep)
